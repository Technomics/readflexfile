...
Just like the single case, use `flatten_data` to create the flat file for each FlexFilein the list. The function will now return a list of flat files.
...
To create a simple flat file, simple stack all of the rows. This will stack them all, storing the file name in a column named `doc_id`.
